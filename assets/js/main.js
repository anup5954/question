...
function addRow() {
  ...
  let cur_count = parseInt($("#attributes .attr:last").find("textarea:last").attr('data-count'));
  row.clone(true, true).find("input:text, textarea, input").val("").end().appendTo("#attributes");
  $("#attributes .attr:last").find("#cke_option_answer_mcq_1").remove();
  $("#attributes .attr:last").find("textarea:last").attr('id','option_answer_mcq_'+(cur_count+1));
  $("#attributes .attr:last").find("textarea:last").attr("data-count",(cur_count+1));
  CKEDITOR.replace('option_answer_mcq_'+(cur_count+1),{ height: '100px' });

}

function removeRow(button) {
  button.closest(".attr").remove();
}
...
function addRow1() {
  let curr_count = parseInt($("#attributes1 .attr1:last").find("textarea:last").attr('data-multi'));
  row1.clone(true, true).find("input:text, textarea, input").val("").end().appendTo("#attributes1");
  $("#attributes1 .attr1:last").find("#cke_option_answer_multi_1").remove();
  $("#attributes1 .attr1:last").find("textarea:last").attr('id','option_answer_multi_'+(curr_count+1));
  $("#attributes1 .attr1:last").find("textarea:last").attr("data-multi",(curr_count+1));
  CKEDITOR.replace('option_answer_multi_'+(curr_count+1),{ height: '100px' });
}

function removeRow1(button) {
  button.closest(".attr1").remove();
}
...
var row2 = $(".attr:first-child");


function addRow2() {
  let edit_cur_count = parseInt($("#attributes .attr:last").find("textarea:last").attr('data-count'));
  var row2Duplicate = row2.clone(true, true).find("input, textarea, button").val("").removeAttr('id').end().appendTo("#attributes");
  $("#attributes .attr:last").find("#cke_option_answer_mcq_1").remove();
  $("#attributes .attr:last").find("textarea:last").attr('id','option_answer_mcq_'+(edit_cur_count+1));
  $("#attributes .attr:last").find("textarea:last").attr("data-count",(edit_cur_count+1));
  CKEDITOR.replace('option_answer_mcq_'+(edit_cur_count+1),{ height: '100px' });
}
...
$('#attributes .attr:first-child').find('.remove2').hide();
...
var row3 = $(".attr1:first-child");

function addRow3() {
  let edit_curr_count = parseInt($("#attributes1 .attr1:last").find("textarea:last").attr('data-multi'));
  row3.clone(true, true).find("input, textarea, button").val("").removeAttr('id').end().appendTo("#attributes1");
  $("#attributes1 .attr1:last").find("#cke_option_answer_multi_1").remove();
  $("#attributes1 .attr1:last").find("textarea:last").attr('id','option_answer_multi_'+(edit_curr_count+1));
  $("#attributes1 .attr1:last").find("textarea:last").attr("data-multi",(edit_curr_count+1));
  CKEDITOR.replace('option_answer_multi_'+(edit_curr_count+1),{ height: '100px' });
}
...
$('#attributes1 .attr1:first-child').find('.remove3').hide();

/* Doc ready */
$(".update-add1").on('click', function () {
  addRow3();  
  if($("#attributes1 .attr1").length > 1) {
...
$(document).ready(function() {
  ...
  $('#add_row').click(function() {
    //Add row
    row = '';
    row += '<tr><td><input type="text" class="form-control"></td><td ><input type="text" class="form-control"></td><td><input type="text" class="form-control"></td><td><input type="text" class="form-control"></td>';
    row += '<td class="text-center"><button class="btn btn-outline-danger delete_row"><i class="fa fa-trash"> </i></button></td></tr>';
    $("tbody").append(row);
  })
