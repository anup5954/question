...
class CommonModel extends CI_Model {
    ...
    public function getPdfData() {
		...
		$output .= '<h2>Overview</h2>
			...
			<p> <strong style="color:#52d43b;">Green </strong>  colour signifies that this particular business area is working satisfactorily or better than expected and that no immediate remedial action is required in this particular business function.</p>
			<p> If you feel these are your strengths you may further work on to achieve faster business growth. </p>
			<p>· <strong style="color:#e4c03b;">YELLOW </strong> colour signifies that this particular business area is not working as it should and that some form of further analysis and remedial action is required.</p>
			<p>·<strong style="color:#cf0004;">RED </strong>  colour signifies that this particular business area is in crisis and that you need to take immediate action to address a serious problem within this business function. Such areas could be responsible for slowing down the pace of growth. In case they are critical to the business, they could be responsible for derailing it totally ignoring other areas of strength. We would highly recommend a quick corrective action on all such areas.</p>
			...
			foreach($categories as $cat){
        		...
        		foreach($cat_options as $cat_option){
        			...
        			if($cat_option->question_id == 75){
						...
						if(count($options) >= 5) {
							$cat_points =  $cat_points + 15;
						} else {
							$cat_points =  $cat_points + 7;
						}
 
        			} 

        			elseif($cat_option->question_id == 76){
						...
						if(count($options) == 1 && in_array(209, $options)) {
